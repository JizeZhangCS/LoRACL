...
parser.add_argument('--rank_of_lora', default=4, type=int,
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if len(weights)==0:
        weights = None
    model = simclr.builder_vit.SimCLR(
    ...
    optimizer = torch.optim.AdamW(model.module.encoder_q.parameters(), init_lr,
                            weight_decay=args.weight_decay)
    
    optimizer_lora = None
    if args.enable_lora:
        optimizer_lora = torch.optim.AdamW(lora.separate_param(model=model.module.encoder_k)[1] , init_lora_lr,
    ...
    if args.resume:
        if os.path.isfile(args.resume):
            ...
            try:
                ...
                print("WARNING: lora optimizer loading failed.")
    ...
    # valid(small_train_loader, val_iid_loader, val_ood_loader, model.module.encoder_q, criterion, args.start_epoch, args)
