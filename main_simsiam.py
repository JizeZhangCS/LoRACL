...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = simsiam.builder.SimSiam(
        ...
        args.dim, args.dim // args.pred_dim_ratio, weights, id_predictor=False)
    ...
    model.module.lora_init(args)
    print(model) # print model after attaching lora
    ...
    optimizer_lora = None
    if args.enable_lora:
        optimizer_lora = torch.optim.SGD(lora_param_list
, init_lora_lr,
                            momentum=args.momentum,
